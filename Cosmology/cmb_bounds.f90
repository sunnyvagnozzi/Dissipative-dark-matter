...
c linearize and change Tn, Tg, Tgp
       ...
       if(i.gt.100) then
       write(6,*) 't=', t*(6.582d-22)
       write(6,*) 'Tg=', Tg, 'Tn=', Tn, 'Tgp=', Tgp, 'Tgpp=', Tabc
       write(6,*) 'ratio=', Tgp/Tg
       i=1
       endif
       i=i+1
c set time step according to neutrino temperature
       ...
       if(Tn.gt.0.6) then
       dt=20*(((10.0/Tn)*(10.0/Tn)*(1.5E21))/(1280000.0))
       else
       dt=12*(((10.0/Tn)*(10.0/Tn)*(1.5E21))/(2510000.0))
       endif
       t=t+dt
       if(Tg.lt.0.025)then
       goto 11
...
6      continue
11     write(6,*) 'x=',((1.0d-9/ep)**(0.5))*((z/me)**(0.25))*(Tgp/Tg)
       end
