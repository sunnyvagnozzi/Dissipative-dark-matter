       Implicit none
       real*8 mergedpk(1:184),Pk(1:92),kappa(1:92),mhalo(1:92)
       real*8 dndm(1:92)
...
c      Open the file, which contains two columns: k and P(k)
       ...
       open(12,file="powermdmx024")

c      Read the file and put it into an array

       read(12,*) (mergedpk(i),i=1,184)
...
c      Variance integral, Eq.(8) in 1412.2133
       ...
       dndm(i4)=dndm(i4)*((conv/h)**(3.0))
4      continue

c      Write halo mass in units of 10^12 solar masses and mass function

       do 5 i5=1, 92, +1
       write(6,*) h*mhalo(i5)/(1.0d12*msun), dndm(i5)
5      continue
